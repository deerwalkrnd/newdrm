...
<ul>
    @foreach($organizations as $organization)
        <li style="list-style:none;"><i class="fas fa-folder fa-2x" id="head{{ $loop->iteration }}" data-unit="body{{ $loop->iteration }}" onclick="toggleDisplay(this.id)" style="color:#3d6f95b5;"></i> <span style="font-size:38px;">{{$organization->nam.", ".$organization->code}}</span></li>
