...
@section('content')
@include('layouts.basic.tableHead',["table_title" => "Leave Request List", "url" => "/leave-request/create"])
<table class="unit_table mx-auto">
    ...
    @empty
    <tr>
        <th colspan=5 class="text-center text-dark">No LeaveRequest Found</th>
    </tr>
    @endforelse
</table>
{{ $leaveRequests->links() }}
