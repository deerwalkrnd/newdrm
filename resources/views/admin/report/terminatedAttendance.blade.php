...
@section('content')
    @include('layouts.basic.tableHead', ['table_title' => 'Terminated Employee Attendance Report'])
...
@section('scripts')
    <script>
        ...
        function download() {
            ...
            window.location.href = `/terminatedattendance/export${queryParams}`;
        }
        function reset() {
            $(location).attr('href', '/terminatedattendancereport');
            updateDownloadLink('');
        }
    </script>
@endsection