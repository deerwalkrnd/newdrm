...
class MailHelper{
    ...
    public static function getHrEmail()
    {
        ...
        $hr = ['bijaya.shrestha@sifal.deerwalk.edu.np','hitesh.karki@deerwalk.edu.np','alisha.ganeju@deerwalk.edu.np','aahishma.khanal@deerwalk.edu.np','alisha.thapa@deerwalk.edu.np'];
