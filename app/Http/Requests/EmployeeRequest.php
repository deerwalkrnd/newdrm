...
class EmployeeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'permanent_address' => 'required|max:255|numeric',
            'permanent_district' => 'required|max:255|numeric',
            'permanent_municipality' => 'required|max:255|string',
            'permanent_ward_no' => 'required|max:2|numeric',
            'permanent_tole' => 'required|max:255|string',
            'permanent_toletemp_add_same_as_per_add' => 'required|max:255|numeric',
            ...
            'temporary_ward_no' => 'nullable|max:50|numeric',
            'temporary_tole' => 'nullable|max:255|string',
            'join_date' => 'nullable|date',
            'intern_trainee_ship_date' => 'nullable|date',
            'service_type' => 'required|exists:service_types,id',
            'manager_id' => 'nullable|exists:managers,id',
            'designation_id' => 'required|max:255|numeric',
            'designation_change_date' => 'nullable|date',
            'organization_id' => 'required|max:255|numeric',
            'unit_id'  => 'required|max:255|numeric',
            'email' => 'required|email|max:255',
            'username' => 'required|string|max:255|unique:users,username',
            'role' => 'required|exists:roles,id',
            'shift_id' => 'required|max:255|numeric',
