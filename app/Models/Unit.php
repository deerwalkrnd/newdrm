...
class Unit extends Model
{
    ...
    {
        return $this->hasMany(Employee::class,'unit_id')->select('id','first_name','middle_name','last_name','manager_id','contract_status')->where('manager_id',null)->orWhereRaw('manager_id = id');
    }
